...
### 이슈 2. V27.1b 판정 미완 — ✅ 해결 (2026-03-15)

**공식 판정: FAIL**

iter 401 heartbeat 기준:
- RL contact=0.071 / prop=0.060 (FL 0.205 대비 약 1/3 수준)
- usage_min=0.049 (floor=0.30 대비 극히 낮음)
- iter 400+ 판정 기준 "즉시 중단 권고" 발동

V27.1b 실패 원인: penalty만으로 특정 다리 참여를 강제하는 구조의 한계.
훈련 중단 완료 (model_400.pt). V28으로 이행.

---

### 이슈 3. V28 원문 수치 미반영 — ✅ 해결 (2026-03-15)

섹션 5.2/5.3 band 수치 실측치 기반으로 교체 완료.
섹션 6 cooperative trigger 조건 및 Layer C/B ramp 구간 명시 완료.

---

### 이슈 4. Layer C/B ramp 비율 미정 — ✅ 해결 (2026-03-15)

섹션 6에 확정 반영:
- iter 250+: Layer C 총합 > Layer B 총합
- iter 0~100: Layer B 우세 허용
...
| 4 | Layer C/B ramp 비율 미정 | ✅ 완료 (2026-03-15) |
